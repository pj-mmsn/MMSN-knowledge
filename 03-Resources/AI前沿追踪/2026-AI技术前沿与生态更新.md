...
| 需更新的文章 | 问题 | 更新方向 |
|-------------|------|---------|
| `框架对比与选型.md` | AutoGen 还是主力 | AutoGen→MAF，加混合架构趋势 |
| `Multi-Agent多智能体.md` | MCP/A2A 只提了一嘴 | 扩展为完整的协议栈章节 |
| `RAG检索增强生成.md` | 停在基础 RAG | 加 GraphRAG / Agentic RAG / 动态图 |
| `记忆系统.md` | 只有 Chroma 自建 | 加 Mem0/Letta/Zep 等专业工具 |
