...
> Java AI 的价值在于**将 AI 能力集成到已有 Java 系统中**（见 `Java AI开发` 系列）。但从零做 Agent，Python 是首选。
...
> **结论**：做 Agent → Python。给 Java 系统加 AI → Java。两者不冲突，你已有的 `Java AI开发` 系列和本目录就是互补关系。
...
📅 第 2 周：Agent 核心
  └── 本目录 Agent核心概念 → 理解 Agent 怎么思考、怎么记忆

📅 第 3 周：框架实战
  └── 本目录 LangChain实战 → LangGraph状态机

📅 第 4 周：多 Agent + 项目
  └── Multi-Agent多智能体 → 04-Archives/ 真实项目复盘
```

## 参考来源

- 本目录各篇专题文章
- `../Python/AI开发Python库速查.md` — 库使用速查
- `Java AI开发生态概览.md` — Java 侧对标文章
